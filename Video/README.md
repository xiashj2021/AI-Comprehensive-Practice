...
![image](Images/App_Images/video_app.png)
...
- `Pre-Processing.ipynb` : Transform the initial CSV file into train and test data sets
- `HOG_Features.ipynb` : A manual extraction of features (Histograms of Oriented Gradients, Landmarks) and SVM
- `Pre-Processing-EmotionalDAN.ipynb` : An implementation of Deep Alignment Networks to extract features
- `LGBM.ipynb` : Use of classical Boosting techniques on top on flatenned image or auto-encoded image
- `Simple_Arch.ipynb` : A simple Deep Learning Architecture
- `Inception.ipynb` : An implementation of the Inception Architecture
- `Xception.ipynb` : An implementation of the Xception Architecture
- `DeXpression.ipynb` : An implementation of the DeXpression Architecture
- `Prediction.ipynb` : Live Webcam prediction of the model
- `Hybrid.ipynb` : A hybrid deep learning model taking both the HOG/Landmarks model and the image
